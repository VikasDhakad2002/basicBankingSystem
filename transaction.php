        ...
        <div class="collapse navbar-collapse " id="navbarNav">
            <ul class="navbar-nav ml-md-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link " href="#">Transact</a>
                </li>
                <li class="nav-item ">
                ...
                <?php 
                    ...
                    { ?>
                        <tr>
                            ...
                            <td><?= $row['email']?></td>
                            <td><?= $row['balance']?></td>
                            <td><button type="button" class="btn btn-primary"><a href = <?="transferMoney.php?id=".$row['id']?> style="color:white;text-decoration:none;"> USE</a></button></td>
                        </tr>
                    <?php }
                ?>
            </tbody>
